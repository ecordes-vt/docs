...
Biometrics | [Face Verification](/developer/engines/cognitive/biometrics/face-verification/) | Determines the similarity between the face in an image to the face of a specified username. In enrollment mode, enrolls the face image into the library under the username.
Biometrics | [Speaker Verification](/developer/engines/cognitive/biometrics/speaker-verification/) | Determines the similarity between the voice in an audio file to the voice of a specified username. In enrollment mode, enrolls the voice in an audio file into the library under the username.
