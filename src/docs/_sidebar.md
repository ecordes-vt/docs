...
- [Automate Studio](automate-studio/)
  ...
  - [Tutorials](automate-studio/blog/automate-blog)
    ...
    - [Creating new training data with a flow](automate-studio/automate-tutorial-6-flow-face-libraries.md)
    - [Automate Studio and Flow Engines](automate-studio/automate-tutorial-7-flow-engines.md)
