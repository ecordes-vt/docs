...
- [Automate Studio](automate-studio/)
  ...
  - [Tutorials]
    - [Separating a Transcription by Speaker in Automate Studio](automate-tutorial-1-flow-transcription-separation.md)
    - [Building Alerting with Face Recognition](automate-tutorial-2-face-recognition-flow.md)
    - [Creating aiWARE Endpoints with Automate](automate-tutorial-3-aiware-api-flow.md)
    - [Analyzing your helpdesk tickets with Sentiment and Automate](automate-tutorial-4-sentiment-helpdesk-flow.md)
    - [Creating a confidence file from your transcipt](automate-tutorial-5-confidence-bot.md)
