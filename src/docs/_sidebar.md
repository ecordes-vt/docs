...
- [Automate Studio](automate-studio/)
  ...
  - [Developer Guide](automate-studio/Training/crawl.md)
    - [The Basics](automate-studio/Training/crawl)
  - [Tutorials](automate-studio/blog/automate-blog)
    - [Orchestrating AI with a Flow](automate-studio/blog/orchestrating-ai.md)
    - [Create aiWARE Custom API Endpoints](automate-studio/blog/your-ai-flow.md)
    - [AI Recognized Your Face. Now What?](automate-studio/blog/ai-recognized-your-face.md)
    - [Sentiment Analysis on Helpdesk Tickets](automate-studio/blog/blog/sentiment-analysis.md)
    - [Creating new training data with a flow](automate-studio/blog/automate-tutorial-6-flow-face-libraries.md)
    - [Automate Studio and Flow Engines](automate-studio/blog/automate-tutorial-7-flow-engines.md)
